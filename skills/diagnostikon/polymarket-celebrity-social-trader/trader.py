...
Trades celebrity, influencer, and social media prediction markets — Elon tweets, viral moments, reality TV, YouTube milestones.
...
KEYWORDS = ['Elon Musk', 'tweet', 'X post', 'Elon tweets', 'YouTube', 'subscribers', 'viral', 'TikTok views', 'celebrity', 'divorce', 'relationship', 'beef', 'reality TV', 'The Bachelor', 'Oscars', 'Golden Globes', 'Trump', 'social media', 'followers', 'Instagram', 'MrBeast', 'PewDiePie', 'Pokimane', 'Logan Paul', 'boxing', 'Jake Paul', 'influencer']
